        ...
        <main class="flex-1">
            <div class="max-w-8xl mx-auto">
                ...
                <div class="mb-6 flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-semibold text-[#213430] app-main">Edit Case Manager</h1>
                        <p class="text-sm text-[#91848C] mt-1 app-text">Update case manager information and settings</p>
                    </div>
                </div>
                ...
                @if (session('success'))
                    <div
                        class="mb-6 rounded-lg border-2 border-green-300 bg-green-50 px-4 py-3 text-green-800 flex items-center gap-2">
                ...
                <div class="bg-[#F3E8EF] rounded-lg p-8">
                    <form method="POST" action="{{ route('admin.case-managers.update', $user) }}" class="space-y-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="grid gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-[#213430] mb-2 app-h">
                                        New Password
                                        <span class="text-[#91848C] text-xs font-normal ml-1">(Leave blank to keep
                                            current)</span>
                                    </label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    ...
                                    @enderror
                                    <p class="text-xs text-[#91848C] mt-2 app-text">Only fill this if you want to change
                                        the password</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    @enderror
                                    <p class="text-xs text-[#91848C] mt-2 app-text">Change account status to activate or
                                        deactivate access</p>
                                </div>
                            </div>
                        </div>
