        ...
        <main class="flex-1 p-6">
            ...
            <div id="eventList" class="space-y-4">
                @forelse ($ongoingEvents as $event)
                    @include('sponsor.events._event_card', ['event' => $event, 'loopIndex' => $loop->index])
                @empty
 ...
 class="modal-overlay">
        <div class="modal-content p-4 max-w-2xl w-full bg-[#F3E8EF] rounded-2xl shadow-lg overflow-y-auto max-h-[95vh]">
            <div class="border border-[#DCCFD8] p-2 rounded-md">
                <div class="p-2 mb-2 border-b border-[#DCCFD8] rounded-md">
                    <h2 id="modalEventTitle" class="text-2xl font-semibold text-gray-900 program-main">Event Details</h2>
                </div>
                ...
                <div class="py-3 text-md text-gray-800 space-y-6">
                    <p id="modalEventDescription" class="text-[#91848C] app-text">
                        A nonprofit initiative supporting women battling breast cancer, raising awareness about early
                    ...
                    <div>
                        ...
                        <div class="flex justify-between gap-6 border border-[#DCCFD8] py-4 px-4 rounded-lg">
                            <div class="flex flex-col gap-2 text-[#91848C] text-sm app-text">
                                ...
                                <span id="modalEventDate" class="text-[#213430] text-base font-medium">TBD</span>
                            </div>
                            <div class="flex flex-col gap-2 text-[#91848C] text-sm app-text">
                                <div>
                                ...
                                <span id="modalEventTime" class="text-[#213430] text-base font-medium">TBD</span>
                            </div>
                            <div class="flex flex-col gap-2 text-[#91848C] text-sm app-text">
                                <div>
                                ...
                                <span id="modalEventLocation" class="text-[#213430] text-base font-medium">TBA</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[#213430] app-text">
                            <li class="flex items-center gap-2 font-medium"><span class="text-pink text-2xl">&#8226;</span> Community awareness sessions</li>
                            <li class="flex items-center gap-2 font-medium"><span class="text-pink text-2xl">&#8226;</span> Support resources and counselling</li>
                            <li class="flex items-center gap-2 font-medium"><span class="text-pink text-2xl">&#8226;</span> Health screenings and consultations</li>
                            <li class="flex items-center gap-2 font-medium"><span class="text-pink text-2xl">&#8226;</span> Stories from survivors & experts</li>
                        </ul>
                    </div>
                        ...
                        <div class="border border-[#DCCFD8] p-2 rounded-md">
                            <div class="flex items-start gap-4 p-4 rounded-md max-w-xl">
                                ...
                                <div class="flex flex-col">
                                    <span id="modalSponsorName" class="font-semibold text-[#213430] mb-1 app-text">Sponsor</span>
                    ...
                    <div class="flex justify-between gap-4 text-sm text-[#213430] app-text border border-[#DCCFD8] rounded-lg p-4">
                        <div class="flex flex-col">
    ...
    <script>
        ...
        function openModal(trigger) {
            ...
            document.getElementById('modalSponsorLogo').src = sponsorLogo || '/images/brand.png';
            document.getElementById('modalSponsorLogo').alt = sponsorName || 'Sponsor logo';
            document.getElementById('modalSponsorAbout').textContent = sponsorAbout || 'Committed supporters partnering with us to impact more lives.';
