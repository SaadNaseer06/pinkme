...
<body style="font-family: Arial, sans-serif; color: #1f2933; line-height: 1.6; margin: 0; padding: 0;">
    <div style="max-width: 640px; margin: 0 auto; padding: 24px;">
        <h2 style="margin: 0 0 16px; color: #d12978;">Program registration {{ strtolower($statusLabel) }}</h2>
        ...
        <p style="margin: 0;">
            <a href="{{ $detailUrl }}" target="_blank" style="color: #d12978;">View registration</a>
        </p>
    </div>
</body>
</html>
