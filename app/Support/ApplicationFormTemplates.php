...
final class ApplicationFormTemplates
{
    ...
    public static function mammogramImaging(): array
    {
        return [
            ...
            self::field('permission_to_share', 'Permission to share information with X-Ray Associates of New Mexico', ApplicationFormFieldTypes::CHECKBOX, required: true, helpText: 'I authorize PINK "ME" to submit my information to X-Ray Associates of New Mexico.'),
    ...
    public static function foodAssistance(): array
    {
        return [
            ...
            self::field(
                'previous_receipt',
                'Upload Previous Grocery Receipt (2nd/3rd request)',
                ApplicationFormFieldTypes::FILE,
                required: true,
                conditionalField: 'receipt_acknowledgment',
                conditionalValue: '1',
            ),
