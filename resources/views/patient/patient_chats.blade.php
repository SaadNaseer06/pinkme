                ...
                <div class="flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-[#DB69A2]" viewBox="0 0 24 24" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M7.5 8.25h9m-9 3.75h6m-8.25 6h12a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25h-12A2.25 2.25 0 0 0 3.75 6.75v9A2.25 2.25 0 0 0 6 18.75Z" />
                    </svg>
                </div>
                <h2 class="text-xl font-semibold text-[#213430]">No Conversations Yet</h2>
                <p class="text-sm text-[#91848C]">You donâ€™t have any active chat with your care team. Once a case manager
                    or admin reaches out, the conversation will appear here.</p>
            </div>
        @else
            <div class="flex flex-col lg:flex-row lg:max-h-[850px] max-w-8xl mx-auto gap-6">
                ...
                <aside class="w-full lg:w-96 bg-[#F3E8EF] rounded-2xl flex flex-col overflow-hidden shadow-sm">
                    <div class="p-5 border-b border-[#E4D6DF] flex items-center justify-between">
                        <h2 class="text-base font-semibold text-[#213430]">Conversations</h2>
                    ...
                    <div class="flex border-b border-[#E4D6DF] text-sm text-[#91848C]">
                        <span
                            class="flex-1 text-center py-3 font-medium text-[#DB69A2] border-b-2 border-[#DB69A2]">All</span>
                        <span class="flex-1 text-center py-3">Unread</span>
                        <span class="flex-1 text-center py-3">Archived</span>
                    </div>
                    <div class="flex-1 overflow-y-auto" data-chat-contact-list>
                        @foreach ($contacts as $contact)
                            <a href="{{ route('patient.patientChats', ['contact' => $contact['id']]) }}"
                    ...
                    <header class="flex items-center justify-between px-6 py-4 border-b border-[#E4D6DF]">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-[#91848C]">Typically replies within a few hours</p>
                            </div>
                        </div>
