<div class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm" data-notification-modal>
    <div class="mx-4 w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <div class="mt-6 flex flex-col gap-2 sm:flex-row sm:justify-end">
            ...
            <a href="#" class="inline-flex items-center justify-center rounded-md bg-[#9E2469] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#B52D75]" data-modal-view>View Details</a>
        </div>
    </div>
</div>
