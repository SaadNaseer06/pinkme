...
<div class="relative inline-block" data-notification-center>
    ...
    <div class="hidden absolute right-0 mt-3 w-80 max-w-[calc(100vw-1rem)] sm:max-w-none rounded-2xl border border-[#E5D6E0] bg-[#F3E8EF] shadow-xl z-50" data-notification-dropdown>
