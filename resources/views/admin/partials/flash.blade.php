        ...
        @if ($successMessage)
            <div class="rounded-xl border border-[#F4C9DD] bg-[#FEF6FB] px-5 py-4 shadow-sm">
                <div class="flex items-start gap-3 text-[#6C5B68]">
                    <span class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#DB69A2]/10 text-[#DB69A2]">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                    </span>
                    <div class="space-y-1">
                        <p class="text-sm font-semibold text-[#C63A85]">Success</p>
        ...
        @if ($errorMessage)
            <div class="rounded-xl border border-[#F7BBCF] bg-[#FFF1F5] px-5 py-4 shadow-sm">
                <div class="flex items-start gap-3 text-[#7B2A54]">
                    <span class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#FCDCE5] text-[#C63A85]">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </span>
                    <div class="space-y-1">
                        <p class="text-sm font-semibold text-[#C63A85]">Something needs attention</p>
        ...
        @if (!empty($formErrors))
            <div class="rounded-xl border border-[#F7BBCF] bg-[#FFF1F5] px-5 py-4 shadow-sm">
                <div class="flex items-start gap-3 text-[#7B2A54]">
                    ...
                    <div class="space-y-2">
                        <p class="text-sm font-semibold text-[#C63A85]">Please review and try again</p>
