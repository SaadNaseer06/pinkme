    ...
    <ul class="mobile-menu">
        <li
            ...
            <a href="{{ route('patient.dashboard') }}">
                <img src="{{ request()->routeIs('patient.dashboard') || request()->routeIs('patient.profile') ? asset('images/Dashboard-svg.svg') : asset('images/App-Dash.svg') }}"
                    alt="">
                Dashboard
            </a>
        </li>
        ...
        <li
            ...
            <a href="{{ route('patient.myApplication') }}">
                <img src="{{ request()->routeIs('patient.myApplication') || request()->routeIs('patient.editApplication') || request()->routeIs('patient.viewApplication') ? asset('images/App-app.svg') : asset('images/My_Application.svg') }}"
                    alt="">
                My Applications
            </a>
        </li>
        ...
        <li class="{{ request()->routeIs('patient.programsAndAids') ? 'active' : '' }}">
            <a href="{{ route('patient.programsAndAids') }}">
                <img src="{{ request()->routeIs('patient.programsAndAids') ? asset('images/program-svg.svg') : asset('images/program.svg') }}"
                    alt="">
                Programs & Aids
            </a>
        </li>
        ...
        <li class="{{ request()->routeIs('patient.patientChats') ? 'active' : '' }}">
            <a href="{{ route('patient.patientChats') }}">
                <img src="{{ request()->routeIs('patient.patientChats') ? asset('images/chat-svg-pink.svg') : asset('images/chat.svg') }}"
                    alt="">
                Chat
            </a>
        </li>
        ...
        <li class="{{ request()->routeIs('patient.faq') ? 'active' : '' }}">
            <a href="{{ route('patient.faq') }}">
                <img src="{{ request()->routeIs('patient.faq') ? asset('images/Faq-pink.svg') : asset('images/FAQ.svg') }}"
                    alt="">
                FAQ
            </a>
        </li>
        ...
        <li class="{{ request()->routeIs('patient.setting') ? 'active' : '' }}">
            <a href="{{ route('patient.setting') }}">
                <img src="{{ request()->routeIs('patient.setting') ? asset('images/setting-pink.svg') : asset('images/setting.svg') }}"
                    alt="">
                Setting
            </a>
        </li>
    ...
    <div class="navigation">
        <ul>
            ...
            <li class="{{ request()->routeIs('patient.programsAndAids') ? 'hovered' : '' }}">
                <a href="{{ route('patient.programsAndAids') }}">
                    <span class="icon"><img
                            src="{{ request()->routeIs('patient.programsAndAids') ? asset('images/program-svg.svg') : asset('images/program.svg') }}"
                            alt="" /></span>
            ...
            <li class="{{ request()->routeIs('patient.patientChats') ? 'hovered' : '' }}">
                <a href="{{ route('patient.patientChats') }}">
                    <span class="icon"><img
                            src="{{ request()->routeIs('patient.patientChats') ? asset('images/chat-svg-pink.svg') : asset('images/chat.svg') }}"
                            alt="" /></span>
            ...
            <li class="{{ request()->routeIs('patient.faq') ? 'hovered' : '' }}">
                <a href="{{ route('patient.faq') }}">
                    <span class="icon"><img
                            src="{{ request()->routeIs('patient.faq') ? asset('images/Faq-pink.svg') : asset('images/FAQ.svg') }}"
                            alt="" /></span>
            ...
            <li class="{{ request()->routeIs('patient.setting') ? 'hovered' : '' }}">
                <a href="{{ route('patient.setting') }}">
                    <span class="icon"><img
                            src="{{ request()->routeIs('patient.setting') ? asset('images/setting-pink.svg') : asset('images/setting.svg') }}"
                            alt="" /></span>
