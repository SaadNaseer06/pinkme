            ...
            <div class="hidden fixed right-10 mt-2 w-72 bg-[#F7EBF3] rounded-xl z-50 profileDropdown">
                ...
                <div class="divide-y divide-[#E5D6E0] max-h-80 overflow-y-auto bg-transparent">
                    <div class="p-3 space-y-3">
                        <a href="{{ route('sponsor.setting') }}" class="flex items-start space-x-3 p-2 rounded-md">
...
<header
    class="mt-4 mr-6 bg-[#F3E8EF] p-4 flex justify-between items-center rounded-lg tab-head md:hidden tab-header">
