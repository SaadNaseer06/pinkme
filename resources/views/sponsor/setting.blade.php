                    ...
                    <div class="bg-[#F3E8EF] rounded-lg p-8">
                            ...
                            <div class="relative">
                                <div class="w-28 h-28 rounded-full p-1">
                                    <div
                                        ...
                                        <img src="/images/profile.png" alt="Profile" class="object-cover" />
                                    </div>
                                </div>
                                <button
                                    class="absolute bottom-[10px] right-[7px] bg-[#DB69A2] text-white rounded-full w-6 h-6 flex items-center justify-center">
                        ...
                        <form>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="firstName"
                                        class="block font-light text-md text-[#213430] mb-1 app-text">First Name:</label>
                                    <input type="text" id="firstName" value="Sara"
                                ...
                                <div>
                                    <label for="lastName" class="block font-light text-md text-[#213430] mb-1 app-text">Last
                                        Name:</label>
                                    <input type="text" id="lastName" value="Tylor"
                                        class="w-full px-4 py-2 font-light rounded-md border border-[#DCCFD8] text-[#B1A4AD] bg-transparent focus:outline-none focus:ring-2 focus:ring-pink-300 app-text" />
                                </div>
                                <div class="md:col-span-2">
                                    <div class="grid grid-cols-4 gap-4">
                                        <div class="col-span-4 md:col-span-2">
                                            <label for="userName"
                                                class="block font-light text-md text-[#213430] mb-1 app-text">User
                                                Name:</label>
                                            <input type="text" id="userName" value="saratylor232@"
                                                class="w-full px-4 py-2 font-light rounded-md border border-[#DCCFD8] text-[#B1A4AD] bg-transparent focus:outline-none focus:ring-2 focus:ring-pink-300 app-text" />
                                        </div>
                                        <div class="col-span-4 md:col-span-1">
                                            <label for="contactNumber"
                                                class="block font-light text-md text-[#213430] mb-1 app-text">Contact
                                                Number:</label>
                                            <input type="text" id="contactNumber" value="(415) 584-9700"
                                                class="w-full px-4 py-2 font-light rounded-md border border-[#DCCFD8] text-[#B1A4AD] bg-transparent focus:outline-none focus:ring-2 focus:ring-pink-300 app-text" />
                                        </div>
                                        <div class="col-span-4 md:col-span-1">
                                            <label for="email"
                                                class="block font-light text-md text-[#213430] mb-1 app-text">Email:</label>
                                            <input type="email" id="email" value="saratylor232@company.com"
                                                class="w-full px-4 py-2 font-light rounded-md border border-[#DCCFD8] text-[#B1A4AD] bg-transparent focus:outline-none focus:ring-2 focus:ring-pink-300 app-text" />
                                        </div>
                                    </div>
                                </div>
                                <div class="grid grid-cols-4 gap-4">
                                    <!-- Gender Dropdown -->
                                    <div class="col-span-4 md:col-span-2">
                                        <label for="gender" class="block font-light text-md text-[#213430] mb-1 app-text">
                                            Gender:
                                        </label>
